<template>
  <section class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-primary-100 overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden">
      ...
      <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-primary-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
    </div>
      ...
      <div class="text-center">
        <div class="mb-8 animate-fade-in-up">
          <h1 class="text-5xl md:text-7xl font-bold text-gray-900 mb-4">
            Hi, I'm <span class="text-primary-600">{{ name }}</span>
          </h1>
          <p class="text-xl md:text-2xl text-gray-600 mb-2">{{ title }}</p>
          <p class="text-lg text-gray-500 max-w-2xl mx-auto">{{ description }}</p>
        </div>
        
        <div class="flex flex-wrap gap-4 justify-center mb-12 animate-fade-in-up animation-delay-200">
