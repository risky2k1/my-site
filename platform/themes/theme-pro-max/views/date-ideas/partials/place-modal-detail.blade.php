<div class="flex-1 flex flex-col overflow-hidden">
    ...
    <div role="tablist" class="tabs tabs-bordered bg-base-200 z-10 w-full grid grid-cols-2">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="rating rating-sm disabled pointer-events-none">
                        ...
                        <input type="radio" name="rating-1-modal" class="mask mask-star-2 bg-orange-400" />
                        <input type="radio" name="rating-1-modal" class="mask mask-star-2 bg-orange-400" />
                        <input type="radio" name="rating-1-modal" class="mask mask-star-2 bg-orange-400" checked />
                ...
                <div class="mt-8 pt-6 border-t border-white/10 flex justify-end gap-3 sticky bottom-0 bg-base-200">
                    <form method="dialog">
        ...
        <input type="radio" name="tabs_place_1" role="tab" class="tab w-full h-auto py-4 text-sm font-medium"
            aria-label="Map" />
