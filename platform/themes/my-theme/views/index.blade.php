        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-lg text-gray-600 mb-8">
                    ...
                    playing games, or enjoying a good movie. I believe in continuous
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        <h4 class="font-semibold text-gray-900 mb-2">DevOps</h4>
                        <p class="text-gray-600">Docker, AWS, CI/CD, Kubernetes</p>
                    </div>
                    <div>
                        <h4 class="font-semibold text-gray-900 mb-2">Tools</h4>
                        <p class="text-gray-600">Git, Figma, VS Code, Postman</p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                <div
                    class="w-full h-96 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center"
                >
                    <i class="fas fa-user text-8xl text-white"></i>
                </div>
                <div
                    class="absolute -bottom-6 -right-6 w-24 h-24 bg-accent rounded-full animate-float"
                ></div>
                <div
                    class="absolute -top-6 -left-6 w-16 h-16 bg-white shadow-lg rounded-full animate-float"
                    style="animation-delay: 2s"
                ></div>
            </div>
        </div>
