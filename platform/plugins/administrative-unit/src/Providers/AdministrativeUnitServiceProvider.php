            ...
            DashboardMenu::make()
                ...
                ->registerItem(
                    DashboardMenuItem::make()
                        ...
                        ->name('plugins/administrative-unit::administrative-unit.cities')
                        ->icon('ti ti-file-text')
                        ->route('administrative-unit.city.index')
                )
                /*->registerItem(
                    DashboardMenuItem::make()
                ...
                ->registerItem(
                    DashboardMenuItem::make()
                        ...
                        ->priority(10)
                        ->parentId('cms-plugins-administrative-unit')
                        ->name('plugins/administrative-unit::administrative-unit.communes')
                        ->icon('ti ti-file-text')
                        ->route('administrative-unit.commune.index')
                )
                ;
        });
