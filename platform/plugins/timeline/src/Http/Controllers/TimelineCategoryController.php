...
class TimelineCategoryController extends BaseController
{
    ...
    {
        $form = TimelineCategoryForm::create()->setRequest($request);
    ...
    public function edit(TimelineCategory $timelineCategory)
    {
        ...
        return TimelineCategoryForm::createFromModel($timelineCategory)->renderForm();
    }

    public function update(TimelineCategory $timelineCategory, TimelineRequest $request)
    {
        TimelineCategoryForm::createFromModel($timelineCategory)
            ->setRequest($request)
            ->save();
